...
class TestStringMethods(unittest.TestCase):
    ...
    def test_booking_withPickupDateBeforeReturnDate(self):
        userBookingData = {"pickUpDate": "2020-05-10", "pickUpTime": "02:03:00", "returnDate": "2020-05-09", "returnTime": "00:21:00", "carID": "6", "username": "s3734938"}
    ...
    # This may have to be modified if db is seeded again with new data. Just enter the details of an existing booking for this to pass.
    # def test_booking_CarNotAvailableInThatSlot(self):
    #     userBookingData = {"pickUpDate": "2020-05-04", "pickUpTime": "02:03:00", "returnDate": "2020-05-09", "returnTime": "00:21:00", "carID": "1", "username": "s3734938"}
    #     userBookingJSONData = json.dumps(userBookingData, cls=DateTimeEncoder)
    #     response = requests.post("http://127.0.0.1:5000/bookingDetails", json=userBookingJSONData)
    #     data = json.loads(response.text)
    #     self.assertEqual(data["message"], "Car not available in this slot")
